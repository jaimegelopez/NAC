function fig1_regulation(Fig1ax,linewidth,fontsize,seed,cutoff)

%This script plots the timecourses of figure 1
...
text(0.5*2.5,2*970,'$\beta = 2$','Interpreter','latex','FontSize',4);
...
text(0.5*2.5,2*970,'$\beta = 20$','Interpreter','latex','FontSize',4);
